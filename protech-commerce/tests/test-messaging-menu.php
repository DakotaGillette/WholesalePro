...
class Test_Messaging_Menu extends WP_UnitTestCase {
	...
	public function test_the_menu_has_a_top_level_item_and_one_sub_page_per_view(): void {
		...
		$this->assertSame(
			array( 'protech-messaging', 'protech-messaging-compose', 'protech-messaging-templates', 'protech-messaging-contacts', 'protech-messaging-log', 'protech-messaging-compliance', 'protech-messaging-settings' ),
			$slugs
		);
	}
